...
public class ParadiseHood : ModItem
{
    ...
    {
        player.GetDamage(DamageClass.Summon) += AdditiveGenericDamageBonus / 100f; // Increase dealt damage for all weapon classes by 20%
        player.GetDamage(DamageClass.Magic) += AdditiveGenericDamageBonus / 100f; // Increase dealt damage for all weapon classes by 20%
    }
