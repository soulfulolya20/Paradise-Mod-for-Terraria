...
public class ParadiseMinion : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            owner.ClearBuff(ModContent.BuffType<ParadiseMinionBuff>());
            return;
        }

        if (owner.HasBuff(ModContent.BuffType<ParadiseMinionBuff>()))
        {
            Projectile.timeLeft = 2;
        }

        AIGeneral(owner, out Vector2 vectorToIdlePosition, out float distanceToIdlePosition);
        AISearchTarget(owner, out bool foundTarget, out float distanceFromTarget, out Vector2 targetCenter);
    ...
    private void AISearchTarget(Player owner, out bool foundTarget, out float distanceFromTarget,
    ...
    private void AIMovement(bool foundTarget, float distanceFromTarget, Vector2 targetCenter,
